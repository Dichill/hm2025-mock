                ...
                >
                    <div className="flex flex-col h-full">
                        ...
                        <p className="text-gray-600 dark:text-gray-300">
                            SpongeBob is a dedicated jellyfisher with over 10
                            years of experience in the field. Hes known for his
                            innovative techniques and has won multiple awards
                            for his contributions to the jellyfishing industry.
                            When not working, he enjoys karate and playing with
