...
export default function ApplicationPage() {
    ...
    // Handle back button click with warning
                    ...
                    >
                        ...
                        <div className="flex justify-end space-x-3">
                            ...
                            <button
                                ...
                                className="px-4 py-2 bg-[rgb(var(--mesa-warm-red))] text-white rounded-md hover:bg-[rgb(var(--mesa-orange))] transition-colors cursor-pointer"
                            >
                                Continue
                            </button>
                        </div>
