...
function ResetPasswordContent() {
    ...
    useEffect(() => {
        ...
        const checkTokenAndType = async () => {
            ...
            // Simply log the token info and finish loading
            if (urlToken && type === "recovery") {
                console.log("Valid reset password link parameters found");
            } else {
                console.log("Missing or invalid reset password parameters");
            }
